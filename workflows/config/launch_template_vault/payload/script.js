/**
 * twitter.services/config/launch_template_vault.js - preflight/postflight functions for twitter.services/config/launch_template_vault
 * @module twitter.services/config/launch_template_vault
 * @file twitter.services/config/launch_template_vault preflight/postflight implementation
 * @author system
 * @copyright Copyright ©2024, Concluent Systems, LLC. All rights reserved.
 */
"use strict";
const MODULE_NAME = "workflow:twitter.services/config/launch_template_vault";
...
function begin (authData, wfProxy, step, theForm) {
    ...
    return new Promise( function(resolve, reject){
        try {
			...
			let settings = {};
			wfProxy.loadAppSettings (authData, "twitter.services")
			.then (data=>{
