/**
 * twitter.services/config/delete_template.js - preflight/postflight functions for twitter.services/config/delete_template
 * @module twitter.services/config/delete_template
 * @file twitter.services/config/delete_template preflight/postflight implementation
 * @author system
 * @copyright Copyright ©2024, Concluent Systems, LLC. All rights reserved.
 */
"use strict";
const MODULE_NAME = "workflow:twitter.services/config/delete_template";
